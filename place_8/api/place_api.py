...
place_model = api.model('Place', {
    ...
    'city_id': fields.String(description='ID of the city', required=True),
    'latitude': fields.Float(description='Latitude'),
    'longitude': fields.Float(description='Longitude'),
    'host_id': fields.String(description='ID of the host', required=True),
...
class Places(Resource):
    ...
    def post(self):
        ...
        response = {'message': 'Place successfully created', 'place_id': place_id}
        return response, 201
